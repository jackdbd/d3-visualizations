...

{
  const draw = (graph) => {
    ...
    const node = div.selectAll('img')
      ...
      .enter()
      .append('img')
      // TODO: How do I know the name of the optmized image asset generated by webpack?
      .attr('src', './Transparent.gif') // from /dist (it's not deleted by CleanWebpackPlugin)
      .attr('class', d => `flag flag-${d.code}`)
      .attr('alt', d => d.country)
      .on('mouseover', (d) => {
        const coordX = d3.event.x;
        const coordY = d3.event.y;
  ...
  d3.json(countriesUrl, (error, data) => {
